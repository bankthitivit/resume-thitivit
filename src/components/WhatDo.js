    ...
    >
      ...
      <div className="flex md:flex-row flex-col items-start justify-start">
          ...
          <div>
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              <p className="text-white text-xl">
                Provide technical advice to customers and sales
                engineer(National Instrument products)
              </p>
              <p className="text-[#B0ADAD] mt-2">
                • Specifications
                <br />• Usability
            ...
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              ...
              <p className="text-[#B0ADAD] mt-2">
                • Data logger program
                <br />• Automation calibrate instrument program
                <br />• Control oscilloscope program
              </p>
            </div>
          </div>
        </div>
        <div className="bg-[#292C36] md:mr-0 mr-3 md:ml-10 ml-0 rounded-xl pt-10 pb-10 mt-8 flex flex-col items-center justify-center">
          ...
          <div>
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              <p className="text-white text-xl">Robot and vision systems</p>
              <p className="text-[#B0ADAD] mt-2">
                • Develop robot ( Epson ) programs together with vision system
              </p>
            </div>
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              <p className="text-white text-xl">
              ...
              <p className="text-[#B0ADAD] mt-2">
                • Count pills machine
                <br />• Take rubber handle machine
                <br />• Packing pills machine
              </p>
            </div>
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              <p className="text-white text-xl">Program AGV (Arduino)</p>
              <p className="text-[#B0ADAD] mt-2">
          ...
          <div>
            ...
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              ...
              <p className="text-[#B0ADAD] mt-2">
                ...
                <br />• Automatic lens filling machine
                <br />• Develop detects lens color machine ( C# )
              </p>
            </div>
            <div className="pt-6 w-96 ml-9 flex flex-col items-start justify-center">
              <p className="text-white text-xl">AGV</p>
              <p className="text-[#B0ADAD] mt-2">
